      ...
      >
        <div className="bg-white shadow-xs shadow-gray-100 rounded-xl p-5">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-gray-700 font-semibold leading-tight text-base">
              {title}
            </h3>
          </div>
          ...
          <div className="flex items-center justify-between overflow-hidden">
            <span className="text-2xl font-semibold text-gray-900 overflow-hidden">
              {value}
            </span>
        ...
        >
          ...
          {link && (
            <Link
              to={link}
              className="text-blue-500 no-underline font-medium text-[12px]"
            >

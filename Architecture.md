...
├── components/      # Only Reuseable components
│   ├── Dashboard/   # Dashboard-specific shared widgets
│   └── ui/          # Low-level UI primitives (Button, Modal, Input, etc.)
├── hooks/           # Custom React hooks
├── Layout/          # Layout wrappers (DashboardLayout, PublicLayout. Dynamic layout for Admin, Public, etc.)
...
│       ├── Components/   # Admin-specific Pages Components
│       ├── PageName.tsx # Admin-specific Pages
│   └── Public/      # General public pages
│       ├── Components/   # Public Pages Components
│       ├── PageName.tsx # Public Pages
...
3. **Rounded Corners:** Consistent use of `rounded-xl` and `rounded-lg` across the application.
